...
angular.module('restApp').run(function($templateCache) {
        ...
        <form name="createForm" class="form-horizontal" ng-submit="create()" novalidate> \
            ...
            <div class="form-group"> <!-- Submit Button --> \
                <div class="col-sm-8 col-sm-offset-4"> \
                    <button type="submit" class="btn btn-primary" ng-disabled="!createForm.$valid">Add Equipment Slot</button> \
                </div> \
            </div> \
        </form> \
    </div> \
    ...
    <div class="col-sm-12"> \
        <span class="text-muted">Current Equipment Slot: </span><span ng-repeat="entity in entities | orderBy:\'value\'"><span ng-show="!$first">, </span>{{entity.code | uppercase}}</span> \
    </div> \
    <!-- -------------------- --> \
    ...
    <div class="col-sm-12"> \
        <p class="text-muted">Update Equipment Slot</p> \
    ...
    ';
    $templateCache.put('equipment_slots', multiStr);
});