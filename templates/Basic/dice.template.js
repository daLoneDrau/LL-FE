...
angular.module('restApp').run(function($templateCache) {
    ...
    <div class="col-sm-10 col-sm-offset-1"> \
        ...
        <form name="createForm" class="form-horizontal" ng-submit="create()" novalidate> \
	        ...
	        <div \
	            class="form-group" \
	            name="divPlus" \
	            ng-class="{ \'has-success\': createForm.txtPlus.$valid && !createForm.txtPlus.$pristine, \'has-error\': createForm.txtPlus.$invalid && !createForm.txtPlus.$pristine }" > \
	            <label for="txtPlus" class="control-label col-sm-4">Plus</label> \
	            <div class="col-sm-8"> \
	                <input class="form-control" id="txtPlus" name="txtPlus" type="number" \
	                        ng-model="newEntity.number" \
	                        ng-minlength="1"\
	                        ng-maxlength="3" \
	                        min="0" \
    ...
    <div class="col-sm-12"> \
        ...
        <form name="updateForm" class="form-horizontal" ng-submit="update()" novalidate> \
	        ...
	        <!-- Update Plus -->  \
	        <div class="form-group" name="divPlus" \
	                ng-class="{ \'has-success\': updateForm.updPlus.$valid && !updateForm.updPlus.$pristine, \'has-error\': updateForm.updPlus.$invalid && !updateForm.updPlus.$pristine }" > \
	            <label for="updPlus" class="control-label">Plus</label> \
	            <input class="form-control" type="number" id="updPlus" name="updPlus" \
	                    ng-model="entitySelect.plus" \
	                    ng-minlength="1"\
	                    ng-maxlength="3" \
	                    min="0" \
	                    ng-pattern="/^[0-9]{1,3}$/" /> \
    ...
    ';
    $templateCache.put('dice', multiStr);
});