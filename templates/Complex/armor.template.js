...
angular.module('restApp').run(function($templateCache) {
    ...
    <!-- -------------------- --> \
    <div class="col-sm-9"> \
        <p class="text-muted">View Armor</p> \
        <form name="updateForm" class="form-horizontal" ng-submit="update()" novalidate> \
	        ...
	        <!-- Update AC --> \
		    <div class="form-group"> \
		        <label for="updAc" class="control-label col-sm-4">Armor Class</label> \
		        <div class="col-sm-8"> \
					<input class="form-control" type="text" disabled \
	    				ng-value=\'((entitySelect.modifiers.ELEMENT_ARMOR_CLASS.value + 9))\' \
	    			/> \
				</div> \
		    </div> \
        </form> \
